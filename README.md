...
- Regula falsi (False position)  *(A)*
- Prostá iterace (Fixed point iteration)  *(A)*
- Steffensenova metoda  *(A)*
- Halleyho metoda  *(A)*
- Newton–Horner (kořen polynomu přes Horner + Newton krok)  *(A)*
...
- Lineární interpolace po částech  *(A)*
...
- Lichoběžníkové pravidlo  *(A)*
- Gaussova kvadratura (např. 2/3 uzly)  *(A)*
- Rombergova kvadratura *(A)* 
